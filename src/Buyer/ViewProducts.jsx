...
const ViewProducts = () => {
    ...
    useEffect(() => {
        axios
            .get("http://localhost:9091/product/viewallproducts")
  ...
  return (
    ...
    {isError !== "" && <h2>{isError}</h2>}
     <Container>
     <Header text="Welcome to All Products View Section"></Header>
     <Row className="justify-content-md-center">
                        {myData.map((post) => {
                            ...
                            return (
                                <Col key={id} lg={3}>
                                    <Card className="mt-5">
                                        <Card.Img variant="top" src={`http://localhost:9091/product/productImage/${id}`} />
